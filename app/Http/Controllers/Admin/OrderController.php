...
//        dd(json_encode($orders));
        ...
        return view('admin.order.index', ['admin' => $admin, 'datas' => $orders]);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('admin.order.index', ['admin' => $admin, 'datas' => $users]);
    }
    ...
    public function info(Request $request)
    {
        ...
        return view('admin.order.info', ['admin' => $admin, 'datas' => $user, 'enters' => $enters]);
    }
